...
import br.com.siprov.jjson.JSONML;
import br.com.siprov.jjson.JSONMLParserConfiguration;
import br.com.siprov.jjson.JSONObject;

/**
 * Tests for br.com.siprov.jjson.JSONML.java
 *
...
public class JSONMLTest {
    ...
    public void emptyTagException() {
        ...
        try {
            ...
            assertEquals("Expecting an exception message",
                "JSONArray[0] is not a String (class br.com.siprov.jjson.JSONArray).",
                e.getMessage());
        }
    }
