package br.com.siprov.jjson.junit;
...
import br.com.siprov.jjson.CDL;
import br.com.siprov.jjson.JSONArray;
import br.com.siprov.jjson.JSONException;
import br.com.siprov.jjson.JSONObject;
import br.com.siprov.jjson.JSONParserConfiguration;
import br.com.siprov.jjson.JSONPointerException;
import br.com.siprov.jjson.JSONString;
import br.com.siprov.jjson.JSONTokener;
import br.com.siprov.jjson.ParserConfiguration;
import br.com.siprov.jjson.XML;
import br.com.siprov.jjson.junit.data.BrokenToString;
import br.com.siprov.jjson.junit.data.ExceptionalBean;
import br.com.siprov.jjson.junit.data.Fraction;
import br.com.siprov.jjson.junit.data.GenericBean;
import br.com.siprov.jjson.junit.data.GenericBeanInt;
import br.com.siprov.jjson.junit.data.MyBean;
import br.com.siprov.jjson.junit.data.MyBeanCustomName;
import br.com.siprov.jjson.junit.data.MyBeanCustomNameSubClass;
import br.com.siprov.jjson.junit.data.MyBigNumberBean;
import br.com.siprov.jjson.junit.data.MyEnum;
import br.com.siprov.jjson.junit.data.MyEnumField;
import br.com.siprov.jjson.junit.data.MyJsonString;
import br.com.siprov.jjson.junit.data.MyNumber;
import br.com.siprov.jjson.junit.data.MyNumberContainer;
import br.com.siprov.jjson.junit.data.MyPublicClass;
import br.com.siprov.jjson.junit.data.RecursiveBean;
import br.com.siprov.jjson.junit.data.RecursiveBeanEquals;
import br.com.siprov.jjson.junit.data.Singleton;
import br.com.siprov.jjson.junit.data.SingletonEnum;
import br.com.siprov.jjson.junit.data.WeirdList;
...
public class JSONObjectTest {
    ...
    public void jsonObjectByResourceBundle() {
        JSONObject jsonObject = new
                JSONObject("br.com.siprov.jjson.junit.data.StringsResourceBundle",
                        Locale.getDefault());
...
//        assertTrue("should convert null to empty string", "".equals(string));
    ...
    */
    ...
    public void jsonObjectClearMethodTest() {
        ...
        jsonObject.getInt("key1"); //Should throws br.com.siprov.jjson.JSONException: JSONObject["asd"] not found
        Util.checkJSONObjectMaps(jsonObject);
    }
