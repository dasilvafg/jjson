...
import io.github.dasilvafg.jjson.JSONML;
import io.github.dasilvafg.jjson.JSONMLParserConfiguration;
import io.github.dasilvafg.jjson.JSONObject;

/**
 * Tests for io.github.dasilvafg.jjson.JSONML.java
 *
...
public class JSONMLTest {
    ...
    public void emptyTagException() {
        ...
        try {
            ...
            assertEquals("Expecting an exception message",
                "JSONArray[0] is not a String (class io.github.dasilvafg.jjson.JSONArray).",
                e.getMessage());
        }
    }
